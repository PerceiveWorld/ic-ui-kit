...
@ProxyCmp({
  ...
  inputs: ['checked', 'closeMenuOnClick', 'description', 'disabled', 'href', 'hreflang', 'keyboardShortcutLabel', 'label', 'referrerpolicy', 'rel', 'submenuTriggerFor', 'target', 'variant']
})
@Component({
  ...
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['checked', 'closeMenuOnClick', 'description', 'disabled', 'href', 'hreflang', 'keyboardShortcutLabel', { name: 'label', required: true }, 'referrerpolicy', 'rel', 'submenuTriggerFor', 'target', 'variant'],
